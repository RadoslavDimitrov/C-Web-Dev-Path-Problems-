...
namespace SharedTrip.Services.Trips
{
    public class TripsService : ITripsService
    {
        ...
        public ICollection<UsersTripInputModel> GetAllUsersToCurrentTrip(string tripId)
        {
            var users = this.db.UserTrips.Where(x => x.TripId == tripId).Select(x => new UsersTripInputModel()
            {
